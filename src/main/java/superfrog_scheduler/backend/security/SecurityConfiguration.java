    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.GET, "/requests").hasAnyAuthority("ROLE_admin", "ROLE_superfrog")
                        ...
                        .requestMatchers(HttpMethod.GET, "/requests/approved").hasAuthority("ROLE_admin")
                        .requestMatchers(HttpMethod.PUT, "/requests/{requestId}/cancel").hasAuthority("ROLE_admin")
                        .requestMatchers(HttpMethod.GET, "/students").hasAuthority("ROLE_admin")
